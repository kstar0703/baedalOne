...
public class OwnerOdersController {
	...
	// 상세내역 보기
	private void oderDetails(String nowCartNo, OwnerCartListDetailDTO dto) {
		System.out.println();
		System.out.println();
		System.out.println();
		System.out.println();
		...
		try {
			...
			List<OwnerCartListDetailDTO> dtoList = service.oderDetails(nowCartNo);

			// 메뉴이름, 가격, 개수를 담은 객체를 출력
			for (OwnerCartListDetailDTO ocDto : dtoList) {
